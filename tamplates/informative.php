        ...
        <section id="page-content" class="page-wrapper bg-color-w section">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-left ">
                                <h2 class="uppercase">Adatvédelmi tájékoztató</h2>
                                <h6 class="mb-40">Elfogadás dátuma: 2020-03-14</h6>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="about-photo p-20 bg-img-1">
                                <img src="img/blog/data_protection.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="about-description mt-20">
                                <h2>ADATKEZELŐ</h2>
                                <p>Név: PD Alba Gsm Korlátolt Felelősségű Társaság</p>
                                <p>Székhely: 1158 Budapest, Drégelyvár utca 33. 9. em. 29. </p>
                                <p>Levelezési cím: 1158 Budapest, Drégelyvár utca 33. 9. em. 29.</p>
                                <p>Adószám: 26552428-2-42</p>
                                <p>Cégjegyzékszám: 01 09 331710</p>
                                <p>E-mail: gabor.papp.86@gmail.com</p>
                                <p>Telefonszám: +36 30 329 8336</p>
                                <p>Weboldal: www.igsmbox.hu</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="team-section">
                <div class="container">
                    <h1>A WEBOLDAL ÜZEMELTETÉSE SORÁN VÉGZETT ADATKEZELÉSEK LEÍRÁSA</h1>
                    <h2 class="mb-20">A COOKIE-K HASZNÁLATÁVAL KAPCSOLATOS TÁJÉKOZTATÁS</h2>
                    <p>Mi az a cookie?
                    ...
                    <ul>
                        <li>Internet Explorer: http://windows.microsoft.com/en-us/internet-explorer/delete-manage-cookies#ie=ie-11</li>
                        <li>Firefox: https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer</li>
                        <li>Mozilla: https://support.mozilla.org/hu/kb/weboldalak-altal-elhelyezett-sutik-torlese-szamito</li>
                        <li>Safari: https://support.apple.com/kb/ph21411?locale=en_US</li>
                        <li>Chrome: https://support.google.com/chrome/answer/95647</li>
                    </ul>
                    <h2 class="mt-20 mb-20">KAPCSOLATFELVÉTEL</h2>
                    ...
                    <h2 class="mt-20 mb-20">REGISZTRÁCIÓ A WEBOLDALON</h2>
                    ...
                    <p>Kezelt adatok</p>
                    <p>Az adatkezelés során az Adatkezelő az Ön nevét, e-mail címét, foglalkozását, telefon típusát kezeli.</p>
                    <p>Az adatkezelés időtartama</p>
                    ...
                    <h2 class="mt-20 mb-20">EGYÉB FOGYASZTÓVÉDELMI PANASZOK KEZELÉSE</h2>
                    ...
                    <p>Az adatkezelés jogalapja</p>
                    <p>Az, hogy hozzánk fordul-e panasszal az Ön önkéntes döntése, azonban ha hozzánk fordul, a fogyasztóvédelemről szóló 1997. évi CLV. törvény 17/A. § (7) bekezdése alapján 5 évig köteles vagyunk a panaszt megőrizni [Rendelet 6. cikk (1) bekezdés c) pont szerinti adatkezelés].</p>
                    <h2 class="mt-20 mb-20">A HOZZÁJÁRULÁS IGAZOLHATÓSÁGÁVAL KAPCSOLATBAN KEZELT ADATOK</h2>
                    ...
                    <h2 class="mt-20 mb-20">MARKETING CÉLÚ ADATKEZELÉSEK</h2>
                    <h2 class="mt-20 mb-20">A HÍRLEVÉL-KÜLDÉSSEL KAPCSOLATOS ADATKEZELÉS</h2>
                    <p>Kezelt adatok</p>
                    <p>Név, e-mail cím.</p>
                    <p>Az adatkezelés időtartama</p>
                    ...
                    <h2 class="mt-20 mb-20">A SZEMÉLYRE SZABOTT REKLÁMOK KÜLDÉSÉVEL ÉS MEGJELENÍTÉSÉVEL KAPCSOLATOS ADATKEZELÉS</h2>
                    <p>Kezelt adatok</p>
                    ...
                    <h2 class="mt-20 mb-20">REMARKETING</h2>
                    ...
                    <p>Google általános cookie tájékoztató: https://www.google.com/policies/technologies/types/</p>
                    <p>Google Analitycs tájékoztató: https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=hu</p>
                    <p>Facebook tájékoztató: https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen</p>
                    <p>Az adatkezelés jogalapja</p>
                    ...
                    <h2 class="mt-20 mb-20">NYEREMÉNYJÁTÉK</h2>
                    <p> Az adatkezelési folyamat a nyereményjáték lebonyolítása érdekében történik.</p>
                    <p>Kezelt adatok</p>
                    <p>Név, email cím, telefonszám.</p>
                    <p>Az adatkezelés időtartama</p>
                    <p>Az adatok a nyereményjáték lezárását követően törlésre kerülnek, kivéve a nyertes adatai, amelyeket a számvitelről szóló törvény alapján 8 évig köteles Adatkezelő megőrizni.</p>
                    <p>Az adatkezelés jogalapja </p>
                    <p>Az Ön önkéntes hozzájárulása, amit a honlap használatával ad meg Adatkezelő számára. [Rendelet 6. cikk (1) bekezdés a) pont szerinti adatkezelés]</p>
                    <h2 class="mt-20 mb-20">TOVÁBBI ADATKEZELÉSEK</h2>
                    ...
                    <h2 class="mt-20 mb-20">KÖNYVELÉSSEL KAPCSOLATOS ADATKEZELÉS</h2>
                    ...
                    <h2 class="mt-20 mb-20">AZ ADATKEZELÉS SORÁN ÖNT MEGILLETŐ JOGOK</h2>
                    ...
                    <h2 class="mt-20 mb-20">ADATVÉDELMI NYILVÁNTARTÁSBA TÖRTÉNŐ BEJELENTKEZÉS</h2>
                    <p>Az Infotv. rendelkezései értelmében az Adatkezelőnek bizonyos adatkezeléseit be kellett jelentenie az adatvédelmi nyilvántartásba. Ez a bejelentési kötelezettség 2020. március 14. napjával megszűnt.</p>
                    <h2 class="mt-20 mb-20">ADATBIZTONSÁGI INTÉZKEDÉSEK</h2>
                    ...
                    <h2 class="mt-20 mb-20">JOGORVOSLATI LEHETŐSÉGEK</h2>
                    ...
                    <h2 class="mt-20 mb-20">ADATKEZELÉSI TÁJÉKOZTATÓ MÓDOSÍTÁSA</h2>
